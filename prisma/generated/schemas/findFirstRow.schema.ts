...
export const RowFindFirstSchema: z.ZodType<Prisma.RowFindFirstArgs> = z.object({ select: RowFindFirstSelectSchema.optional(), include: RowIncludeObjectSchema.optional(), orderBy: z.union([RowOrderByWithRelationInputObjectSchema, RowOrderByWithRelationInputObjectSchema.array()]).optional(), where: RowWhereInputObjectSchema.optional(), cursor: RowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RowScalarFieldEnumSchema, RowScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RowFindFirstArgs>;

export const RowFindFirstZodSchema = z.object({ select: RowFindFirstSelectSchema.optional(), include: RowIncludeObjectSchema.optional(), orderBy: z.union([RowOrderByWithRelationInputObjectSchema, RowOrderByWithRelationInputObjectSchema.array()]).optional(), where: RowWhereInputObjectSchema.optional(), cursor: RowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RowScalarFieldEnumSchema, RowScalarFieldEnumSchema.array()]).optional() }).strict();
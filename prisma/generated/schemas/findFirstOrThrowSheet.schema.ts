...
export const SheetFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SheetSelect> = z.object({
...
export const SheetFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    ownerId: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const SheetFindFirstOrThrowSchema: z.ZodType<Prisma.SheetFindFirstOrThrowArgs> = z.object({ select: SheetFindFirstOrThrowSelectSchema.optional(), include: SheetIncludeObjectSchema.optional(), orderBy: z.union([SheetOrderByWithRelationInputObjectSchema, SheetOrderByWithRelationInputObjectSchema.array()]).optional(), where: SheetWhereInputObjectSchema.optional(), cursor: SheetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SheetScalarFieldEnumSchema, SheetScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SheetFindFirstOrThrowArgs>;

export const SheetFindFirstOrThrowZodSchema = z.object({ select: SheetFindFirstOrThrowSelectSchema.optional(), include: SheetIncludeObjectSchema.optional(), orderBy: z.union([SheetOrderByWithRelationInputObjectSchema, SheetOrderByWithRelationInputObjectSchema.array()]).optional(), where: SheetWhereInputObjectSchema.optional(), cursor: SheetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SheetScalarFieldEnumSchema, SheetScalarFieldEnumSchema.array()]).optional() }).strict();
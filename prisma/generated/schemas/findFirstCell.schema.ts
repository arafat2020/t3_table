...
export const CellFindFirstSelectSchema: z.ZodType<Prisma.CellSelect> = z.object({
...
export const CellFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    rowId: z.boolean().optional(),
    colIndex: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const CellFindFirstSchema: z.ZodType<Prisma.CellFindFirstArgs> = z.object({ select: CellFindFirstSelectSchema.optional(), include: CellIncludeObjectSchema.optional(), orderBy: z.union([CellOrderByWithRelationInputObjectSchema, CellOrderByWithRelationInputObjectSchema.array()]).optional(), where: CellWhereInputObjectSchema.optional(), cursor: CellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CellScalarFieldEnumSchema, CellScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CellFindFirstArgs>;

export const CellFindFirstZodSchema = z.object({ select: CellFindFirstSelectSchema.optional(), include: CellIncludeObjectSchema.optional(), orderBy: z.union([CellOrderByWithRelationInputObjectSchema, CellOrderByWithRelationInputObjectSchema.array()]).optional(), where: CellWhereInputObjectSchema.optional(), cursor: CellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CellScalarFieldEnumSchema, CellScalarFieldEnumSchema.array()]).optional() }).strict();
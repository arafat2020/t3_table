...
export const SheetFindManySelectSchema: z.ZodType<Prisma.SheetSelect> = z.object({
...
export const SheetFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    ownerId: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const SheetFindManySchema: z.ZodType<Prisma.SheetFindManyArgs> = z.object({ select: SheetFindManySelectSchema.optional(), include: SheetIncludeObjectSchema.optional(), orderBy: z.union([SheetOrderByWithRelationInputObjectSchema, SheetOrderByWithRelationInputObjectSchema.array()]).optional(), where: SheetWhereInputObjectSchema.optional(), cursor: SheetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SheetScalarFieldEnumSchema, SheetScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SheetFindManyArgs>;

export const SheetFindManyZodSchema = z.object({ select: SheetFindManySelectSchema.optional(), include: SheetIncludeObjectSchema.optional(), orderBy: z.union([SheetOrderByWithRelationInputObjectSchema, SheetOrderByWithRelationInputObjectSchema.array()]).optional(), where: SheetWhereInputObjectSchema.optional(), cursor: SheetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SheetScalarFieldEnumSchema, SheetScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const RowFindFirstOrThrowSchema: z.ZodType<Prisma.RowFindFirstOrThrowArgs> = z.object({ select: RowFindFirstOrThrowSelectSchema.optional(), include: RowIncludeObjectSchema.optional(), orderBy: z.union([RowOrderByWithRelationInputObjectSchema, RowOrderByWithRelationInputObjectSchema.array()]).optional(), where: RowWhereInputObjectSchema.optional(), cursor: RowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RowScalarFieldEnumSchema, RowScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RowFindFirstOrThrowArgs>;

export const RowFindFirstOrThrowZodSchema = z.object({ select: RowFindFirstOrThrowSelectSchema.optional(), include: RowIncludeObjectSchema.optional(), orderBy: z.union([RowOrderByWithRelationInputObjectSchema, RowOrderByWithRelationInputObjectSchema.array()]).optional(), where: RowWhereInputObjectSchema.optional(), cursor: RowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RowScalarFieldEnumSchema, RowScalarFieldEnumSchema.array()]).optional() }).strict();
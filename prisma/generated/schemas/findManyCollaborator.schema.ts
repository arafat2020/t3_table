...
export const CollaboratorFindManySelectSchema: z.ZodType<Prisma.CollaboratorSelect> = z.object({
...
export const CollaboratorFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    sheetId: z.boolean().optional(),
    userId: z.boolean().optional(),
    role: z.boolean().optional(),

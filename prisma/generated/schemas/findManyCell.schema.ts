...
export const CellFindManySelectSchema: z.ZodType<Prisma.CellSelect> = z.object({
...
export const CellFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    rowId: z.boolean().optional(),
    colIndex: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const CellFindManySchema: z.ZodType<Prisma.CellFindManyArgs> = z.object({ select: CellFindManySelectSchema.optional(), include: CellIncludeObjectSchema.optional(), orderBy: z.union([CellOrderByWithRelationInputObjectSchema, CellOrderByWithRelationInputObjectSchema.array()]).optional(), where: CellWhereInputObjectSchema.optional(), cursor: CellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CellScalarFieldEnumSchema, CellScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CellFindManyArgs>;

export const CellFindManyZodSchema = z.object({ select: CellFindManySelectSchema.optional(), include: CellIncludeObjectSchema.optional(), orderBy: z.union([CellOrderByWithRelationInputObjectSchema, CellOrderByWithRelationInputObjectSchema.array()]).optional(), where: CellWhereInputObjectSchema.optional(), cursor: CellWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CellScalarFieldEnumSchema, CellScalarFieldEnumSchema.array()]).optional() }).strict();
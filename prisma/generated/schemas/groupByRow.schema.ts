...
import { RowAvgAggregateInputObjectSchema as RowAvgAggregateInputObjectSchema } from './objects/RowAvgAggregateInput.schema';
import { RowSumAggregateInputObjectSchema as RowSumAggregateInputObjectSchema } from './objects/RowSumAggregateInput.schema';

export const RowGroupBySchema: z.ZodType<Prisma.RowGroupByArgs> = z.object({ where: RowWhereInputObjectSchema.optional(), orderBy: z.union([RowOrderByWithAggregationInputObjectSchema, RowOrderByWithAggregationInputObjectSchema.array()]).optional(), having: RowScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(RowScalarFieldEnumSchema), _count: z.union([ z.literal(true), RowCountAggregateInputObjectSchema ]).optional(), _min: RowMinAggregateInputObjectSchema.optional(), _max: RowMaxAggregateInputObjectSchema.optional(), _avg: RowAvgAggregateInputObjectSchema.optional(), _sum: RowSumAggregateInputObjectSchema.optional() }).strict() as unknown as z.ZodType<Prisma.RowGroupByArgs>;
